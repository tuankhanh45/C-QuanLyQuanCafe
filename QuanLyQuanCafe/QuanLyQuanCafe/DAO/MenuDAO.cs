...
namespace QuanLyQuanCafe.DAO
{
    public class MenuDAO
    {
        ...
        public List<Menu> GetListMenuByTable(int id)
        {
            ...
            //string query = "SELECT f.name, bi.count, f.price, f.price*bi.count AS totalPrice FROM dbo.BillInfo AS bi, dbo.Bill AS b, dbo.Food AS f WHERE  b.idTable = " + id; // bi.idBill = b.id AND bi.idFood = f.id AND-
